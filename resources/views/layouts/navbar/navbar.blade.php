            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                {{-- <li class="nav-item dropdown language-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        ...
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('/src/assets/img/1x1/tr.svg') }}" class="flag-width" alt="flag"> <span
                                class="align-self-center">&nbsp;Turkish</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('/src/assets/img/1x1/br.svg') }}" class="flag-width" alt="flag"> <span
                                class="align-self-center">&nbsp;Portuguese</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('/src/assets/img/1x1/in.svg') }}" class="flag-width" alt="flag">
                            <span class="align-self-center">&nbsp;Hindi</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('/src/assets/img/1x1/de.svg') }}" class="flag-width" alt="flag">
                    ...
                    <a href="" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                        ...
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                ...
                                @else
                                    <img alt="avatar" src="{{ asset('/src/assets/img/uploadimg.png') }}"
                                        class="rounded-circle">
                                @endif
                            </div>
                        </div>
                        ...
                        {{-- <div class="dropdown-item">
                            <a>
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    </svg> <span><button class="dropdown-item">Logout</button></span>
                                </form>
                            </a>
                        </div> --}}
                        <div class="dropdown-item">
