    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb d-flex justify-content-between align-items-center">
                ...
                <li class="breadcrumb-item active" aria-current="page">All User Promocode</li>
                <li>
                    <button class="btn btn-primary additem _effect--ripple waves-effect waves-light"
                        data-bs-toggle="modal" data-bs-target="#addUserPromocode">Add Promocode</button>
                </li>
            </ol>
        </nav>
    </div>

    @include('livewire.modals.promocode.add-user-promocode')
    @include('livewire.modals.promocode.edit-user-promocode')
                    ...
                    <tbody>
                        @foreach ($promocodelist as $list)
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <a class="" wire:click="editUserPromocode({{ $list->id }})" data-bs-toggle="modal"
                                        data-bs-target="#editUserPromocode" style="cursor: pointer;">
