    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header" id="inputFormModalLabel">
                <h5 class="modal-title">Add <b>Intro Banner</b></h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="">
                            <label>Image <span class="text-danger">(360 x 780)</span></label>
                ...
                <div class="row">
                    <div class="mb-3 col-md-12">
                        ...
                        <textarea type="text" name="description" wire:model="description" class="form-control form-control-sm" placeholder="Description"
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-light-danger mt-2 mb-2 btn-no-effect">
                    <a class="" href="{{ route('banner.introbanner.list') }}">Cancel</a>
                </button>
               
                <!-- Submit Button (Visible when not loading) -->
                <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect"
                    wire:click="addIntroBanner" wire:loading.remove wire:target="addIntroBanner">
                    Submit
                </button>

                <!-- Loading Button (Visible during loading) -->
                <button class="btn btn-primary mt-2 mb-2" type="button" wire:loading wire:target="addIntroBanner" disabled>
