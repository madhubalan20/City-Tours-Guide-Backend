<div wire:ignore.self class="modal fade inputForm-modal" id="deleteTourPlace" tabindex="-1" role="document"
    aria-labelledby="inputFormModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" id="inputFormModalLabel">
                <h5 class="modal-title">Delete <b>Tour Place</b></h5>
            ...
            <div class="modal-body">
                <div class="row ">
                    <div class="col-sm-12">
                        <div class="modal-body">
                            <p class="modal-text text-center">Are you sure to delete this <b>{{ $delete_title }}</b>
                                tour!</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect" id="submitBtn"
                    onclick="handleSubmit()" wire:click="deleteTourPlace()">
                    Submit
                </button>
