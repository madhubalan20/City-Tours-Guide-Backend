<div wire:ignore.self class="modal fade inputForm-modal" id="deleteReport" tabindex="-1" role="document"
    aria-labelledby="inputFormModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" id="inputFormModalLabel">
                <h5 class="modal-title">Delete <b>User report</b></h5>
            ...
            <div class="modal-body">
                <div class="row ">
                    <div class="col-sm-12">
                        <div class="modal-body">
                            <p class="modal-text text-center">Are you sure you want to delete this user <b>{{ $user_name }}</b>
                                report?</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-light-danger mt-2 mb-2 btn-no-effect">
                    <a class="" href="{{ route('user.reports') }}">Cancel</a>
                </button>

                <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect" id="submitBtn"
                    onclick="handleSubmit()" wire:click="deleteReport()">
                    Submit
                </button>
