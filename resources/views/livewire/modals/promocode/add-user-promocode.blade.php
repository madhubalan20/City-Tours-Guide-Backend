<div>
    ...
    <div wire:ignore.self class="modal fade inputForm-modal" id="addUserPromocode" tabindex="-1" role="document"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3" wire:ignore>
                            <div class="form-group">
                                ...
                                <select class="selectpicker" multiple data-live-search="true" wire:model='user_name'>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="">
                                ...
                                <textarea type="text" name="description" wire:model="description" class="form-control form-control-sm"
                                    rows="1" placeholder="Description" autocomplete="on"></textarea>
                                @error('description')
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect" wire:click="addCoupon"
                        wire:loading.remove wire:target="addCoupon">
                        Submit
                    </button>

                    <!-- Loading Button (Visible during loading) -->
                    <button class="btn btn-primary mt-2 mb-2" type="button" wire:loading wire:target="addCoupon"
                        disabled>
